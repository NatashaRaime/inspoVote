...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { districtId: @voter.districtId, email: @voter.email, name: @voter.name, passwordHash: @voter.passwordHash, voterId: @voter.voterId } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { districtId: @voter.districtId, email: @voter.email, name: @voter.name, passwordHash: @voter.passwordHash, voterId: @voter.voterId } }
