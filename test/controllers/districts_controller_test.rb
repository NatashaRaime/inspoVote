...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { districtId: @district.districtId, name: @district.name, stateId: @district.stateId } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { districtId: @district.districtId, name: @district.name, stateId: @district.stateId } }
