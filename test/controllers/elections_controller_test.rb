...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { completed: @election.completed, districtId: @election.districtId, electionDate: @election.electionDate, electionId: @election.electionId, title: @election.title } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { completed: @election.completed, districtId: @election.districtId, electionDate: @election.electionDate, electionId: @election.electionId, title: @election.title } }
